	...
	<?php
		...
		<br><br><br>
			<table class="table">
				<thead>
					<tr>
						<th><a style="font-family:Broadway">Customer ID</th>
				...
				<?php
					while($row=$result->fetch_assoc()):?>
						...
						<tr>
							<td><a style="font-family:Elephant;"><?php echo $row['customer_id']?></td></a>
							...
							<td>
								<a href="index5.php?edit=<?php echo $row['code_no'];?>"
									class="btn btn-info">Edit</a>
								<a href="process3.php?delete=<?php echo $row['code_no'];?>"
