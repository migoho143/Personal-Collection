...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2019 at 01:05 AM
...
--
ALTER TABLE `crud`
  ADD CONSTRAINT `crud_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
